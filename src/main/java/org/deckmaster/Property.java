...
public enum Property {
    ...
    RESIDENCE("images/properties/RESIDENCE.png", "Residence.Fireplace, warm bed, and food: anything that you can think of as \"home.\""),
    RITUAL_DAWN("images/properties/RITUAL_DAWN.png", "The Ritual of Dawn. A ritual is a large-scale magic that combines spells, runes, and planning. This is the ritual from the Dawn Church."),
